...
function setupTabSwitching() {
	...
	// Xóa listener cũ để tránh trùng lặp (nếu có)
...
// [SỬA] Hàm tải hộp thư đến (Đã thêm nút Trả lời và Xóa)
...
window.sendMessage = sendMessage; // Hàm này sẽ hoạt động lại sau khi login mới
