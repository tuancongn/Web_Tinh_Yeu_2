...
async function login() {
    ...
    try {
        // Supabase Auth uses email for password sign-in.
        // To allow username/phone login, you would need a separate lookup table.
        const { data, error } = await supabase.auth.signInWithPassword({
            email: identifier, // For now, assume identifier is an email
            password: password
        });
        ...
        showNotification('Lỗi', 'Email hoặc mật khẩu không đúng!', 'error');
    }
}
